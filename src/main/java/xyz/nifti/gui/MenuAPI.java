...
import xyz.nifti.gui.menu.SGMenuListener;
import xyz.nifti.gui.menu.SGOpenMenu;
...
public class MenuAPI {
    ...
    /**
     * Whether the inventory click actions should be
     ...
     */
    private boolean enableAutomaticPagination = false;
    ...
    /**
     * Default icon, used to create fast SGButtons.
     * <p>
     * The main application of this is custom font menus,
     * where {@link Material#BARRIER} with {@code customModelData 2} used to create empty buttons.
     * <p>
     * More about this read in plugins wiki: TODO link to wiki
     */
    private ItemStack defaultIcon = new ItemBuilder(Material.BARRIER).customModelData(2).build();
     ...
     * this class by calling {@link #create(String, int)} on the static {@link MenuAPI} field.
     * <p>
     ...
     * 27, you would supply 3 as the value of the {@code rows} parameter.
     *
     * <br><br>
     *
    ...
    public SGMenu create(String name, int rows, String tag) {
        return new SGMenu(getPlugin(), this, name, rows, tag);
    }


    /**
     * Set default {@link ItemStack icon} for default {@link SGButton Buttons}
     *
     * @param icon icon for default buttons
     * @see SGButton
     */
    public void setDefaultIcon(ItemStack icon) {
        this.defaultIcon = icon;
    }

    /**
     * Get default {@link ItemStack icon} for default {@link SGButton Buttons}
     *
     * @return icon for default buttons
     * @see SGButton
     */
    ...
    /**
     * @see MenuAPI#blockDefaultInteractions
     *
    ...
    /**
     * Returns the value of {@link MenuAPI#blockDefaultInteractions} for this plugin.
     *
    ...
    /**
     * @see MenuAPI#enableAutomaticPagination
     *
    ...
    /**
     * Returns the value of {@link MenuAPI#enableAutomaticPagination} for this plugin.
     *
    ...
    /**
     * @see MenuAPI#defaultPaginationButtonBuilder
     *
